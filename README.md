## Core Machine Learning and AI Foundations

These are good first resources to build intuition before going deeper into math or implementation.
...
3. [Essential Machine Learning and AI Concepts Animated](https://youtu.be/PcbuKRNtCUc?si=NeaSJt_VVAkZ49XL)
4. [Neural Networks by 3Blue1Brown](https://youtube.com/playlist?list=PLZHQObOWTQDNU6R1_67000Dx_ZCJB-3pi&si=83Z97JTe2OiClvk7)
5. [Understanding Deep Learning — Simon J.D. Prince (Book)](https://udlbook.github.io/udlbook/)
6. [Understanding Deep Learning — YouTube Playlist](https://youtube.com/playlist?list=PLmp4AHm0u1g0AdLp-LPo5lCCf-3ZW_rNq&si=dDLQxMFX20YVpmGq)
7. [Deep Learning — Mitesh Khapra](https://youtube.com/playlist?list=PLEAYkSg4uSQ1r-2XrJ_GBzzS6I-f8yfRU&si=A4XVBP1vMublbJkU)
...
Build these alongside the core ML material.
...
1. [Mathematics for Deep Learning Playlist](https://youtube.com/playlist?list=PL05umP7R6ij0bo4UtMdzEJ6TiLOqj4ZCm&si=m-2OnjVGfYuPKtr-)
2. [Mathematics for Deep Learning with Codes](https://github.com/SoR-D/Mathematics-for-Deep-Learning)
3. [Linear Algebra and Random Processes — Mitesh M. Khapra](https://www.cse.iitm.ac.in/~miteshk/CS6015.html)

### Additional Math References
...
After basic ML intuition, move into hands-on implementation.
...
### PyTorch Internals and Debugging
...
These are important concepts that support later advanced topics.

1. [Understand Convolution — Better Explained](https://betterexplained.com/articles/intuitive-convolution/)
2. [Understand Convolution — MathWorks](https://in.mathworks.com/discovery/convolution.html)
...
5. [KL Divergence](https://youtu.be/q0AkK8aYbLY?si=Wb7BJWFk6l5zW_67)
6. [Discrete Fourier Transform Playlist](https://youtube.com/playlist?list=PLs8w1Cdi-zvY_BI7Fe0nYETCVoVhptFaf&si=yQI1wFEZYLN_aFuL)
7. [YOLOv1 Explained](https://youtu.be/zgbPj4lSc58?si=7082Ct-RIg4Yoxfm)
...
A natural next step after basic deep learning.
...
### Vision Transformers
1. [Vision Transformer From Scratch](https://youtu.be/pACWvXc-GLs?si=LIn29f-xGkUYy-H0)
2. [Implement and Train ViT From Scratch for Image Recognition — PyTorch](https://youtu.be/Vonyoz6Yt9c?si=1bSgFETiMPXqw-ss)
...
Best explored after basic neural networks, PyTorch, and transformers.

### General Introduction
1. [Generative Modelling Playlist](https://youtube.com/playlist?list=PLaw_1rrGFgySRIL-vz2CegKre7Qhy0Lee&si=xnv4FPG2auIb_rIp)
...
7. [ProGAN Paper Walkthrough](https://youtu.be/lhs78if-E7E?si=JYt_qQjUiuKKfdl4)
8. [ProGAN Implementation From Scratch](https://youtu.be/nkQHASviYac?si=uyfIQb0at9BYBHU8)
9. [SRGAN Paper Walkthrough](https://youtu.be/fx-rXMcKlQc?si=88k7HFX1hPCx-olV)
10. [SRGAN Implementation From Scratch](https://youtu.be/7FO9qDOhRCc?si=hT992fUyBe2_72Hc)
11. [StyleGAN Paper Walkthrough](https://youtu.be/qZuoU23ACTo?si=ZLgHJ39Wfhc-yO2Q)
12. [StyleGAN Implementation From Scratch](https://www.kaggle.com/code/tauilabdelilah/stylegan-implementation-from-scratch-pytorch)
13. Related code: [GANs Implemented From Scratch](https://github.com/SoumyaratnaDebnath/Deep-Learning-Algorithms-Implemented/tree/main/GANs-implemented-from-scratch)

### Variational Autoencoders
1. [Variational Autoencoder Explained](https://youtu.be/iwEzwTTalbg?si=Wv4mQJKNllMZvM3q)
2. [Variational Autoencoder Paper Walkthrough](https://youtu.be/5bA6gwo36Cw?si=lEdLDp4zCgl6DSCQ)
3. [VAE Implementation From Scratch](https://youtu.be/VELQT1-hILo?si=2BlGkoynHX-5Tdwh)
4. Related code: [Variational Autoencoder From Scratch](https://github.com/SoumyaratnaDebnath/Deep-Learning-Algorithms-Implemented/tree/main/variational-autoencoder-from-scratch)
...
6. [DDPM Explained](https://youtu.be/H45lF4sUgiE?si=zxuqNRH1LkJ1Xl93)
7. [DDPM Implementation From Scratch](https://youtu.be/vu6eKteJWew?si=o3x6HAsttKfQT2gs)
...
Useful for computer vision, rendering, and scene understanding.

### Computer Graphics
1. [Learn Computer Graphics — Scratchapixel](https://www.scratchapixel.com/index.html)

### Neural Radiance Fields (NeRF)
1. Neural Radiance Fields Paper Explained:
   - [Resource 1](https://youtu.be/HfJpQCBTqZs?si=mqgFPRlmCrSwVX1t)
   - [Resource 2](https://youtu.be/oKKeae_Sc-I?si=sel8y2-zf0wrhkvT)
   - [Resource 3](https://youtu.be/WSfEfZ0ilw4?si=Nek9sUqZTDpHM5Uk)
   - [Resource 4](https://youtu.be/CRlN-cYFxTk?si=4Bdm83jNngYfrkat)
2. Understanding NeRFs:
   - [Resource 1](https://theaisummer.com/nerf/)
   - [Resource 2](https://cameronrwolfe.substack.com/p/understanding-nerfs)
3. Coding Neural Radiance Fields:
   - [Resource 1](https://youtu.be/Q1zqf5tfeJw?si=x-sEgEgdYUfbRjQS)
   - [Resource 2](https://papers-100-lines.medium.com/neural-radiance-fields-nerf-tutorial-in-100-lines-of-pytorch-code-365ef2a1013)
4. [NeRF: A Volume Rendering Perspective](https://yconquesty.github.io/blog/ml/nerf/nerf_rendering.html)
...
Separate from the main ML flow, but useful as an additional area of interest.
...
1. [Explained Visually](https://setosa.io/ev/)
2. [AI But Simple](https://www.aibutsimple.com/)
3. [ExplainingAI](https://youtube.com/@explaining-ai?si=ZJCs0AUEZQcFQn2t)
...
Helpful once you start reading papers and doing projects.

### Staying Updated
1. [Automatically Update CV Papers Daily Using GitHub Actions](https://github.com/Vincentqyw/cv-arxiv-daily/tree/main)
2. [Conference Deadlines](https://ccfddl.com/)

### Conference Quality / Rankings
1. [CORE Conference Rankings](https://portal.core.edu.au/conf-ranks/)
2. [Resurchify Conference Ranking](https://www.resurchify.com/conference-ranking)

### Research and PhD Guidance
1. [A Survival Guide to a PhD — Andrej Karpathy](https://karpathy.github.io/2016/09/07/phd/)
2. [PhD / Research Blog Resource](https://krrish94.github.io/blog/)

### Fellowships and Opportunities
1. [List of Fellowships for Graduate Students](https://github.com/SoumyaratnaDebnath/Graduate-Fellowships)

### Rapid Prototyping
1. [AutoGluon Quick Prototyping](https://auto.gluon.ai/stable/index.html)
...
1. [Mathematics for Deep Learning with Codes](https://github.com/SoR-D/Mathematics-for-Deep-Learning)
2. [Graph Convolution Networks From Scratch](https://github.com/SoumyaratnaDebnath/Deep-Learning-Algorithms-Implemented/tree/main/graph-convolution-networks-from-scratch)
3. [Vision Transformer From Scratch](https://github.com/SoumyaratnaDebnath/Deep-Learning-Algorithms-Implemented/tree/main/vision-trasnformer-from-scratch)
4. [GANs Implemented From Scratch](https://github.com/SoumyaratnaDebnath/Deep-Learning-Algorithms-Implemented/tree/main/GANs-implemented-from-scratch)
