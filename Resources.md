**Introduction to Flow Matching and Diffusion Models** `Diffusion` <br>
...
`Diffusion` [Link to Course](https://huggingface.co/learn/diffusion-course/en/unit0/1)
...
`Diffusion` [Link to Course](https://youtube.com/playlist?list=PLlZRoE1e4FG7Ax89tyiPpBRByN6QR-TZV&si=334HbVJhzOKivekY)
...
#### `Computer Graphics` Introduction to Computer Graphics - Justin Solomon [MIT]
...
#### `Computer Graphics` Discrete Differential Geometry - Keenan Krane [CMU]
...
#### `Linear Algebra` Linear Algebra and Random Processes - Mitesh M. Khapra
